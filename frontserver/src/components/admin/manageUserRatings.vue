...
export default{ 
    ...
    methods:{
        ...
        async getUserRatings(){
            try{
                const response = await api.get('/profile/ratings',{withCredentials:true});
        ...
        async submitAddRating(){
            try{
                const response = await api.post('/admin/addUserRating',this.newRating,{withCredentials:true});
