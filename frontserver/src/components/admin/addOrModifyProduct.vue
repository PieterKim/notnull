...
export default{ 
    ...
    created(){
        ...
        if(this.$route.params.id){
            ...
            api.get(`/admin/products/${productID}`,{withCredentials:true})
            .then(response => {
    ...
    methods:{
        ...
        async uploadDescriptionImage() {
            ...
            try {
                ...
                const response = await api.post('/admin/upload/descriptionImg', formData, {
                    headers: {
        ...
        async uploadProductImage() {
            ...
            try {
                ...
                const response = await api.post('/admin/upload/productImg', formData, {
                    headers: {
                        'Content-Type': 'multipart/form-data'
                    },
                    withCredentials:true
        ...
        async AddProduct(){
            try{
                const response = await api.post('/admin/addProduct', this.product,{withCredentials:true});
        ...
        async ModifyProduct(){
            try{
                const response = await api.patch('/admin/modifyProduct', this.product,{withCredentials:true});
                if(response.status === 200){
